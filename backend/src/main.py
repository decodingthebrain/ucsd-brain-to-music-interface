...
while count > 0:
    ...
    if time_left == 25:
        ...
        prompt = f"{state_prompt} Find a song that matches user state and is similar to {current_track_name} by {current_track_artist}.{camelot_prompt}**Important**: Avoid songs from this list and their variations: {recently_played}. Reply with only the song name and artist of the song in this format: Title: <insert title>\n Artist: <insert artist name>"
